...
import calv4Styles from './calv4.module.scss';

const Calv4 = () => (
    <div className={calv4Styles.container}>

{/* <div className={calv4Styles.subContainer}> */}
        <svg
        ...
        >
            ...
            <svg className={calv4Styles.inner} viewBox="0 0 800 650">
                <rect className={calv4Styles.bg} width="100%" height="100%" />

                <g className={calv4Styles.row1}>
                    <rect className={calv4Styles.a} />
                    <rect className={calv4Styles.b} />
                    <rect className={calv4Styles.c} />
                    <rect className={calv4Styles.d} />
                    <rect className={calv4Styles.e} />
                    <rect className={calv4Styles.f} />
                    <rect className={calv4Styles.g} />
                </g>
            ...
            <text className={calv4Styles.desknote} x="20" y="330">DESK</text>
            <text className={calv4Styles.tabnote} x="20" y="330">Tablet</text>
            <text className={calv4Styles.phonenote} x="20" y="330">PHONE</text>
        </svg>
{/* </div> */}
